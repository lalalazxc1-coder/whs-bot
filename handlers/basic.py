...
async def cmd_help(message: types.Message):
    ...
    text = (
        ...
        "🔹 `⚠️ Сообщить о проблеме` - Написать в техподдержку (можно фото/видео)\n"
    )
    
    if user_id in config.ADMIN_IDS:
        text += (
            "\n👮‍♂️ **Admin Help:**\n"
            "🔸 `/admin` - **Панель Администратора** (Рассылки, Отчеты Excel, Контакты)\n"
            ...
            "🔸 *В ответ на тикет в чате админов:* просто отправьте `ID` тикета цифрами."
        )
